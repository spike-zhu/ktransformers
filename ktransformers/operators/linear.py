...
class KLinearTorch(KLinearBase):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        infinicore_gemm_input_c_fp32 = torch.ones((batch_size, seq_len, out_features), device = out_device, dtype = torch.float32)
        ...
        workspace = create_workspace(workspace_size.value, infinicore_gemm_input_a_fp32.device)
